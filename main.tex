...
sources (proven by the user base of astroquery).  While this may change in the
future, the user-focused nature of astroquery means that making such changes is
unnecessary until there are specific data sources or use cases to drive such a
change.
