...
\begin{deluxetable*}{lp{8.5cm}ll}
  ...
  \package{hitran} & HIgh-resolution TRANsmission molecular absorption database & \url{http://hitran.org/hapi} \\
...
\astroquery also receives contributions from other funded programs. For
instance, the JPLHorizons module has been implemented as part of the
\texttt{sbpy} project\footnote{\url{http://sbpy.org}}. Further Solar
System-related services are planned to be added to \astroquery through this
support. \astroquery has also received support from the Google Summer of
Code program.
...
supported the project in a number of different ways. We are greatful for the
...
we are greatful for their maintainers and contributors: \package{requests}
\package{beautifulsoup}, and \package{keyring}.

We thank Google for financing and organizing the Google Summer of Code
program, that has funded 2 students (SL, and MP) to work on \astroquery in
2013 and 2014.
