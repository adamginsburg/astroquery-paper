...
\newcommand{\astroquery}{\texttt{astroquery}}
...
research the (raw) data needs to be available to everyone. Many scientific journals 
encourage or sometimes demands the underlying data to accompany the article or be 
uploaded to a hosting service. Thus data sharing is not only important for new 
results, but also for being able to go back and check old results. While many 
different efforts of sharing data has made it more common, it is difficult 
to keep track of everything. A common scripted interface to tie all these 
services together is a good way to make all the different data more accessible.
