...
For new service development, there is a \texttt{template_module} that lays
...
While there is a common suggested API described in the \texttt{template_module},
...
\subsection{The API}
The common API has a few features defined in the \texttt{template_module}.
