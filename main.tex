...
served by the typical astronomical databases.  Examples include static databases, for instance of molecular
and atomic properties, as those provided by Splatalogue and NIST, or services that are computationally intensive or require constant updates, like Solar System ephemerides.  
...
Deviations from this standard API are documented in the \astroquery documentation (see Section \ref{sec:documentation}).
