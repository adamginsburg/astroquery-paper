...
with versions indicated in the format MAJOR.MINOR.PATCH.  However,
\astroquery patches are frequently made to accommodate upstream changes,
i.e., changes made to the service being queried, and as such are not
