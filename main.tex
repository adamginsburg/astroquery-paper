...
VO Cone Search has \texttt{query\_*\_region} interface like the
other \astroquery services in addition to the existing interfaces ported over
...
Python \texttt{import} statements (e.g., \texttt{from astroquery import vo_conesearch as vo}
instead of \texttt{from astropy import vo}).
