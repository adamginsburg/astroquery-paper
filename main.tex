...
\begin{deluxetable*}{lp{8.5cm}ll}
  ...
  \package{hitran} & HIgh-resolution TRANsmission molecular absorption database & \url{http://hitran.org/hapi}, \citet{Kochanov2016a} \\
...
A list of supported services at the time of publication is given in Table
\ref{tab:surveys}.
...
to physical data that are not related to positions on the sky and therefore
...
Users do not need to be aware of these metadata being sent with their
...
data through Python.  It is part of the \astropy affiliated package system.
...
and unit tools.  This example, shown in Figure 1, approximately reproduces Figure 1 of
